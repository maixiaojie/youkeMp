<template>
    <div class="skeletons" v-show="!completed">
...
.skeletons .skeletons-container .list-row {
    padding: 30rpx;
    margin-top: 35rpx;
    height: 60rpx;
...
.skeletons .skeletons-container .list-row .circle {
    width: 40rpx;
    height: 40rpx;
    border-radius: 50%;
...
.skeletons .skeletons-container .list-row .rect {
    flex: 1;
    height: 20rpx;
    border-radius: 10rpx;
    margin: 0 20rpx;
...
.skeletons .skeletons-container .rect-row {
    width: 90%;
    height: 20rpx;
    border-radius: 10rpx;
    margin: 0 20rpx;
